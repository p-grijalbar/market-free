module.exports = function (processor) {
        ...
        menu += '<div class="col-lg-3 ms-paper-menu-left-container">' +
                '<div class="ms-paper-menu-left">' +
                    '<h3 class="ms-paper-menu-title">' +
                        ...
                        '<a role="button" data-bs-toggle="collapse" href="#collapseMenu" aria-expanded="false" aria-controls="collapseMenu" class="withripple"><i class="zmdi zmdi-menu"></i></a>' +
                    '</h3>' +
    ...
    function generateMenu(name, children, active_link, num) {
        ...
        r += '<a role="button" data-bs-toggle="collapse" href="#c' + num + '" aria-expanded="true" aria-controls="c' + num + '" class="';
        r += active ? '' : 'collapsed ';
        r += 'withripple">';
        r += name + '</a>';
        r += '<ul id="c' + num + '" class="panel-collapse collapse';
        r += active ? ' show' : '';
        r += '" role="tabpanel" aria-labelledby="e' + num + '" data-bs-parent="#components-nav">';
        r += submbenu;
        r+= '</ul></li>';
        return r;
    }
